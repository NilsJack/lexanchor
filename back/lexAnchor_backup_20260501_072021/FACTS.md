...
Development header fallback remains available, but is not full authentication/RBAC:
...
- Session control is lightweight and local; real identity-provider login, membership checks, and RBAC remain future work.
...
- Replace development login with real identity-provider login and signed/session-backed membership checks.
...
- Keep the 25-test suite passing as session control, v1.0 action workflow, and rule-authoring fields expand.
