...
- Replace header-only scope with signed authentication, membership checks, and role permissions.
...
- Keep the 24-test suite passing as v1.0 action workflow and rule-authoring fields expand.
