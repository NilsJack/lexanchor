...
def draft_rules_from_text(payload: RuleDraftRequest, request: Request) -> RuleDraftResponse:
    ...
    assert_permission(scope, "rule_draft:create")
...
def lawyer_ui_recommendations(request: Request) -> LawyerUiRecommendationResponse:
    ...
    return LawyerUiRecommendationResponse(
        ...
        server_hardening=[
            {"area": "auth", "recommendation": "Replace development sessions with identity-provider login, membership checks, and full RBAC policy storage.", "priority": "critical"},
